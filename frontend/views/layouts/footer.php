                    ...
                    <div class="col-lg-4 col-md-12 col-sm-12">
                         <div class="footer-top-box">
                              ...
                              <form class="newsletter-box">
                                   ...
                                   <button class="btn hvr-hover" type="submit">Gửi đi</button>
                              </form>
                         </div>
                    </div>
                    <div class="col-lg-4 col-md-12 col-sm-12">
                         <div class="footer-top-box">
                              ...
                              <p>Hãy đưa cửa hàng chúng tôi vươn đi muôn nơi</p>
                              <ul>
                                   <li><a href="https://www.facebook.com/h.strinh.vietanh/"><i class="fab fa-facebook" aria-hidden="true"></i></a></li>
                                   <li><a href="https://twitter.com/Trinh_Viet__Anh/"><i class="fab fa-twitter" aria-hidden="true"></i></a></li>
               ...
               <div class="row">
                    <div class="col-lg-4 col-md-12 col-sm-12">
                         <div class="footer-widget">
                              <h4>King of Sneakers</h4>
                              <p>Là một trong những thương hiệu sneaker nổi tiếng và đáp ứng đủ nhu cầu khách hàng mong muốn... Chúng tôi luôn tự tin trên thị trường Việt Nam để đưa tới trải nghiệm thoải mái nhất cho quý khách hàng !</p>
                              <p>Hãy luôn đồng hành cùng King of Sneakers nhé cả nhà ơi ... ! </p>
                         </div>
                    </div>
                    <div class="col-lg-4 col-md-12 col-sm-12">
                    ...
                    <div class="col-lg-4 col-md-12 col-sm-12">
                         <div class="footer-link-contact">
                              ...
                              <ul>
                                   <li>
                                        <p><i class="fas fa-map-marker-alt"></i>Địa chỉ: Số 54 Triều Khúc<br> Quận Thanh Xuân, <br>TP.Hà Nội</p>
                                   </li>
                                   <li>
                                        <p><i class="fas fa-phone-square"></i>Số điện thoại: <a href="tel:+1-888705770">099999999</a></p>
                                   </li>
                                   <li>
